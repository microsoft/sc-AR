...
You can use the implemented function `calculate_resampling_weights()` located in `scripts/AR_resampling_weight_calculator.py` such as the way shown in the `AR_custom_model_tutorial.ipynb` notebook.
