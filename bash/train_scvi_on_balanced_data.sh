...
out_path=$3        # path to the folder for saving trained models (ends with /saved_models/balanced_data/)
...
balancing_method=${13} # balancing method from class_balancing or geometric_sketching
