...
seed=(50 60 70 80 90)            # seed number
log_path=./log        # path to save logs
root=../            # root folder of the project
model_name=scvi      # model type: scvi or scgen
latent_dim=64      # latent dimension
num_epoch=(200 500)       # number of epochs
AR=(True False)           # AR flag: True or False
atlas_count=(0 1 10 100 1000 10000 50000)  # number of atlas cells, e.g., 0, 1, 10, 100, 1000, 10000, 50000
